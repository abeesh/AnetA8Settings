...
#define STRING_CONFIG_H_AUTHOR "(Abeesh, Anet mod config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "AM8 modified"
...
*/
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 50, 400, 435.48 }
